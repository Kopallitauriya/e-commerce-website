            ...
            <div className='col-3'>
              ...
              <div className='filter-card mb-3'>
                ...
                <div>
                  ...
                  <h5 className='sub-title d-flex'>Price</h5>
                  ...
                  <h5 className='sub-title d-flex'>Color</h5>
                  <div>
                    <div>
                  ...
                  <h5 className='sub-title d-flex'>Size</h5>
                  <div>
                    <div className="form-check">
              ...
              <div className='filter-card mb-3'>
                ...
                <div>
                  <div className='random-products text-dark d-flex flex-column justify-content-evenly '>
                    ...
                    <div className='d-flex flex-row '>
                      ...
                      <div className='w-50'>
                        <h5>Kids headphones bulk 10 pack muti colored for students.
                    ...
                    <div className='d-flex flex-row  m-4'>
                      ...
                      <div className='laptoprandom w-50 '>
                        <h5>Kids headphones bulk 10 pack muti colored for students.
                ...
                <div className='d-flex justify-content-between align-items-center'>
                  <div className='d-flex align-items-center gap-10'>
                    ...
                    <select name='' className='form-control form-select' id=''>
                      ...
                      <option v alue='Price-descending'>price, high to low</option>
