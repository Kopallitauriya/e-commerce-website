        ...
        <>
            ...
            <div className='compare-product-wrapper py-5 home-wrapper-2'>
                <div className='container-xxl'>
                    <div className='row'>
                        <div className='col-3'>
                            <div className='compare-product-card position-relative m-3'>
                        ...
                        <div className='col-3'>
                            <div className='compare-product-card position-relative m-3'>
                                ...
                                img-fluid' />
                                <div className='product-card-image'>
                                    <img src='images/watch.jpg' alt='speaker' className='img-fluid' />
                                </div>

                                <div className='compare-product-details'>
                                    <h5 className='title'>Loop Watch BAnd For 42mm/44mm watch</h5>
